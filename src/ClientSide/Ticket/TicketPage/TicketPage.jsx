        ...
        <div className="ticketInputDiv bg-white rounded-full flex items-center">
          ...
          {isDialogOpen && (
            <div className="fixed inset-0 p-4 flex flex-wrap justify-center items-center w-full h-full z-[1000] before:fixed before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)] overflow-auto font-[sans-serif]">
              <div className="py-[50px] xs:px-[20px] xs:py-[25px] px-[24px] md:py-[60px] md:px-[90px] lg:py-[70px] lg:px-[100px] xl:py-[80px] xl:px-[110px] bg-white shadow-lg rounded-lg relative">
          ...
          {/* Dialog 2 */}
          {isDialog2Open && (
            <div className="fixed inset-0 xl:px-[240px] flex flex-wrap w-full justify-center items-center h-full z-[1000] before:fixed before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)] overflow-auto font-[sans-serif]">
              <div className="py-[50px] xs:px-[20px] xs:py-[25px] px-[24px] md:py-[60px] md:px-[90px] lg:py-[70px] lg:px-[100px] xl:py-[80px] xl:px-[110px] bg-white shadow-lg rounded-lg relative">
                    ...
                    <div className="flex justify-center gap-[10px] pb-[40px]">
                      {otpValues.map((otp, index) => (
                        <input
                          ...
                          className="w-[40px] h-[40px] md:w-[50px] md:h-[50px] lg:w-[55px] lg:h-[55px] xl:w-[60px] xl:h-[60px] text-center border border-[#1E1E1E99] rounded-md focus:outline-none focus:ring-2 focus:ring-[#7EA254] text-lg font-medium"
                        />
                      ))}
                    </div>
                  </form>
